...
**Ele pode inventar coisas**
Como ele gera texto provável — não necessariamente verdadeiro —, às vezes cria informações falsas com muita confiança. Isso tem um nome: "alucinação". Sempre verifique dados importantes em outras fontes.

**Ele não tem memória entre conversas**
Cada conversa começa do zero. Ele não lembra do que você conversou ontem (a menos que plataformas específicas guardem esse histórico para você).

**Ele não acessa a internet em tempo real** (na versão básica)
O modelo foi treinado até uma data específica. Perguntas sobre eventos recentes podem receber respostas desatualizadas ou incorretas.

**Ele não raciocina como humanos**
Apesar das aparências, ele não "reflete" sobre problemas. Em tarefas que exigem lógica complexa ou múltiplos passos, pode errar de formas que um humano não erraria.
